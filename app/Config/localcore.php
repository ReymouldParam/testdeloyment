...
define('IS_LIVE', '1');
define('HTTP_PATH', 'http://' . $_SERVER['SERVER_NAME'] . '/referjob_live/');
define("BASE_PATH", $_SERVER['DOCUMENT_ROOT'] . "/referjob_live/");
...
define('UPLOAD_EMPLOYEE_VERIFICATION_PATH', BASE_PATH . '/app/webroot/files/verification_document/');
