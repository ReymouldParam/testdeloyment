...
Router::connect('/skills/add', array('controller' => 'skills', 'action' => 'add'));
...
Router::connect('/payments/creditHistory', array('controller' => 'payments', 'action' => 'creditHistory'));
Router::connect('/plans/ajaxPlan', array('controller' => 'plans', 'action' => 'ajaxPlan'));
Router::connect('/plans/ajaxPlanSubmit', array('controller' => 'plans', 'action' => 'ajaxPlanSubmit'));
...
Router::connect('/users/uploadresume', array('controller' => 'users', 'action' => 'uploadresume'));
...
Router::connect('/users/basicProfile', array('controller' => 'users', 'action' => 'basicProfile'));
...
Router::connect('/users/resendEmail', array('controller' => 'users', 'action' => 'resendEmail'));
Router::connect('/users/recreate-account', array('controller' => 'users', 'action' => 'recreateAccount'));
Router::connect('/users/reactive-account', array('controller' => 'users', 'action' => 'reActiveAccount'));
/* --Candidate-- */
...
Router::connect('/cron/remove-deleted-accounts', array('controller' => 'cron', 'action' => 'removeDeletedAccounts'));
...
/* --Job-- */
Router::connect('/jobs/importjob', array('controller' => 'jobs', 'action' => 'importjob'));
Router::connect('/jobs/listing', array('controller' => 'jobs', 'action' => 'listing'));
Router::connect('/jobs/old_listing', array('controller' => 'jobs', 'action' => 'old_listing'));
...
Router::connect('/jobs/cronEmail', array('controller' => 'jobs', 'action' => 'cronEmail'));
Router::connect('/payments/cronEmail', array('controller' => 'payments', 'action' => 'cronEmail'));
Router::connect('/jobs/employeeEmailVerfication', array('controller' => 'jobs', 'action' => 'employeeEmailVerfication'));
Router::connect('/jobs/employeeDocumentVerfication', array('controller' => 'jobs', 'action' => 'employeeDocumentVerfication'));
Router::connect('/jobs/employeeVerficationLater', array('controller' => 'jobs', 'action' => 'employeeVerficationLater'));
Router::connect('/jobs/jobsDetails', array('controller' => 'jobs', 'action' => 'jobsDetails'));
Router::connect('/jobs/ajaxJobSave', array('controller' => 'jobs', 'action' => 'ajaxJobSave'));
Router::connect('/jobs/ajaxJobUnSave', array('controller' => 'jobs', 'action' => 'ajaxJobUnSave'));
Router::connect('/jobs/ajaxApplyJob', array('controller' => 'jobs', 'action' => 'ajaxApplyJob'));
Router::connect('/jobs/testdinesh', array('controller' => 'jobs', 'action' => 'testdinesh'));
