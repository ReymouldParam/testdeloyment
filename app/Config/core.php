...
CakeLog::config('error', array(
    'engine' => 'FileLog',
    'types' => array('error'),
    'file' => 'error', // Change this to the desired log file
));
/**
...
define('MAIL_FROM', 'info@stage.reyferjobs.com');
define('FEEDBACK_MAIL', 'info@stage.reyferjobs.com');
define('ENQUIRY_MAIL', 'info@stage.reyferjobs.com');
define('PAYMENT_ENQUIRY_MAIL', 'info@stage.reyferjobs.com');
define('HOME_META_TITLE', 'Job Board Software | Job Board Portal - Reyferjobs');
...
// define('HTTP_PATH', $protocol.$_SERVER['SERVER_NAME'] . '');
define('HTTP_PATH', $protocol.$_SERVER['SERVER_NAME'] . '');
define("BASE_PATH", $_SERVER['DOCUMENT_ROOT'] . '');
// define("BASE_PATH", $_SERVER['DOCUMENT_ROOT'] . "");
define('HTTP_IMAGE', HTTP_PATH . '/app/webroot/img');

define('BACKGROUND_PATH', HTTP_PATH.'/jobs/cronEmail');
define('BACKGROUND_TEMPLATES_PATH', HTTP_PATH.'/payments/cronEmail');
...
define('UPLOAD_JOB_DESCRIPTION_PATH', BASE_PATH . 'app/webroot/files/jobdescription/');
define('DISPLAY_JOB_DESCRIPTION_PATH', HTTP_PATH . '/app/webroot/files/jobdescription/');
...
define('UPLOAD_APPLY_JOB_CERTIFICATE_PATH', BASE_PATH . '/app/webroot/files/certificates/applyjob/');
...
define('UPLOAD_EMPLOYEE_VERIFICATION_PATH', BASE_PATH . '/app/webroot/files/verification_document/');define('DISPLAY_EMPLOYEE_VERIFICATION_PATH', HTTP_PATH . '/app/webroot/files/verification_document/');
...
///////shivani
 ////define('CAPTCHA_KEY', '6LfAf0UjAAAAACi8T2IaR5b3hmY8AmwlUNpSx9SW');
 ////define('CAPTCHA_SECRET_KEY', '6LfAf0UjAAAAAK-XXQmAxiBUa8Bc8X0CRJI8fxrq');
 
 define('CAPTCHA_KEY', '6Lf1L5glAAAAALPv9SM6FHZ1kJp0brSQmMlEXHv5');
 define('CAPTCHA_SECRET_KEY', '6Lf1L5glAAAAALh1bHUYmMPlfSt1lpg45hHVWg_I');
...
/* --Demo app gmail-- */
define('GMAIL_CLIENT_ID', '105878004219-udr8q5bke9u4vt7amnv5rp74he7924ji.apps.googleusercontent.com');
define('GMAIL_SECRET', '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');
define('GMAIL_DEVELOPER_KEY', 'AIzaSyDkBBb9ZJtpxtOXVL75JPOpHX01GepGCm4');
...
define('LINKEDIN_API_KEY', '77nkxirt7yopwc');
define('LINKEDIN_SECRET', 'g6HWAvc6P6cmE4UT');
...
define('LINKEDIN_REDIRECT', HTTP_PATH.'/users/linkedinlogin');
...
//define('AUTO_SUGGESTION', 'AIzaSyBqdy82sEIazQCEM3lajeKBYcYOzbJbt08'); 
//define('AUTO_SUGGESTION', 'AIzaSyAsGaaegbkLCY19n7lE6OEimozgyTnxRkk'); 
