...
//        exit;
        ...
        if ($this->data) {
            ...
            if (empty($this->data["Alert"]["skill"])) {
                $msgString .= __d('controller', 'Please select Skill.', true)."<br>";
            } else {
                $skill = $this->data["Alert"]["skill"];
            }
            ...
            if (isset($msgString) && $msgString != '') {
                ...
                $this->request->data['Alert']['skill'] = $skill;
                $this->request->data['Alert']['designation'] = (!empty($this->data["Alert"]["designation"]))?$this->data["Alert"]["designation"] : null;
