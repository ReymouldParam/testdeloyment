...
class User extends AppModel {
	...
	function isRecordUniquecontact($phoneNumber = null) {

        $resultUser = $this->find('count', array('conditions' => "User.contact = '" . addslashes($phoneNumber) . "'"));
	...
	function isRecordUniquecontactEdit($phoneNumber = null, $id = null) {

        $resultUser = $this->find('count', array('conditions' => "User.contact = '" . addslashes($phoneNumber) . "' AND User.id!='" . $id . "'"));
...
//echo $resultUser;exit();
    ...
    function isDeactivatedAccount($email_address = null) {
        $resultUser = $this->find('first', array('conditions' => "User.email_address = '" . addslashes($email_address) . "' AND User.status = 0  AND User.deactivate_date IS NOT NULL "));
