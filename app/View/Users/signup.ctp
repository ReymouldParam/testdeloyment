<?php //pr($_SESSION);   
    if(isset($deactivated_account) && !empty($deactivated_account)){
    ?>
...
<script type="text/javascript">
    ...
    Swal.fire({
        ...
        if (result.value) {
            var reCreateAccountInput = $('<input>')
                .attr({
                    type: 'hidden',
                    name: 're_create_account',
                    id: 'reCreateAccount',
                    value: '<?= $deactivated_account ?>'
            });
            $('#userRegister').append(reCreateAccountInput);
            $('#userRegister').submit();

        } else {
            var reActivateAccountInput = $('<input>')
                .attr({
                    type: 'hidden',
                    name: 're_activate_account',
                    id: 'reActivateAccount',
                    value: '<?= $deactivated_account ?>'
            });
            $('#userRegister').append(reActivateAccountInput);
            $('#userRegister').submit();
        }
    });
...
<section class="slider_abouts">
    <div class="breadcrumb-container">
        <nav class="breadcrumbs page-width breadcrumbs-empty">
            <h3 class="head-title">  
			<?php echo __d('user', 'Sign up', true); ?>
			</h3>
                            ...
                            <div class="form_contnrd">
                                ...
                                <div class="form_lst choose-list">
                                    <div id="cust_skl" class="rltv rel_Skills category_drop">
                                        <div class="info-field">
                                            <?php echo $this->Form->select('User.total_exp', $totalexperienceArray, array('empty' => __d('user', 'Select Total Work Experience', true), 'class' => "form-control",'onchange' => 'displayCompany(this);')); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="form_lst" id="ccname" style="display:none">
                                    <div class="rltv">
                                        <div class="info-field">
                                            <div class="form_lst_row">
                                                <?php echo $this->Form->text('User.company_name', array('class' => "form-control", 'placeholder' => __d('user', 'Company Name', true))) ?>
                                            </div>
                                        </div>
                                    </div>                                                       
                                </div>
                                <div class="form_lst">
                                    <div class="rltv">
                                        <div class="info-field">
                                            <div class="form_lst_row">
                                                <?php echo $this->Form->text('User.first_name', array('maxlength' => '20', 'class' => "required form-control", 'placeholder' => __d('user', 'First Name', true))) ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form_lst">
                                    <div class="rltv">
                                        <div class="info-field">
                                            <div class="form_lst_row">
                                                <?php echo $this->Form->text('User.last_name', array('maxlength' => '20', 'class' => "required form-control", 'placeholder' => __d('user', 'Last Name', true))) ?>
                                            </div>
                                        </div>
                                    </div>                    
                                </div>
								...
								<div class="form_lst">
                                    <div class="rltv">
                                        <div class="info-field">
                                            <div class="form_lst_row">
                                                <?php echo $this->Form->text('User.contact', array('maxlength' => '10', 'class' => "required form-control", 'placeholder' => __d('user', 'Phone Number', true))) ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
								...
								<div class="row_defaultt">
									<div class="col_devide_full reun_takine">
										<a class="btn btn-default google" href="<?php echo $googleLoginUrl; ?>"> <i class="fa fa-google-plus modal-icons"></i> Signup with Google </a>
										<?php echo $this->Html->link('<i class="fa fa-linkedin modal-icons"></i> Signup with Linkedin', array('controller' => 'users', 'action' => 'linkedinlogin'), array('class' => 'btn btn-default google', 'escape' => false)); ?>
