...
<?php
    ...
    $this->Html->addCrumb($slug, array('controller' => 'jobs', 'action' => 'accdetail', $slug));
                    ...
                    <div class="info_dv">
                        ...
                        <div class="information_cntn">
                            ...
                            <?php 
                                ...
                                elseif(!empty($this->data['Job']['description_url'])){
                                    $description_option = "Url";
                                }
                                else{
                                    $description_option = "Doc";
                                }
                            ?>
                            ...
                            <div class="form_lst">
                               <label><?php echo __d('user', 'Work From', true); ?> <span class="star_red">*</span></label>
                               <span class="rltv">
                                <?php 
                            ...
                            <div class="form_lst">
                                <label><?php echo __d('user', 'Job Description Options', true); ?> <div class="star_red">*</div></label>
                                   
                                <div class="dty" style="padding-left: 1.5rem;">
                                    <?php
                                    $options = array(
                                    ...
                                    echo $this->Form->radio('Job.jdoptions', $options, array('escape' => false, 'label' => false, 'legend' => false, 'separator' => '</div><div class="dty">', 'default' => $description_option));
                                    ?>
                                </div>  
                            </div>
                            
                          
                            <div class="form_lst" id="jddocsec">
                                <label><?php echo __d('user', 'Job Description', true);?> <span class="star_red">*</span></label>
                                <span class="rltv">
                                    <?php echo $this->Form->file('Job.description_document', array('class' => 'form-control')); ?>
                                    <div class="abccc pstrength-minchar"> <?php echo __d('user', 'Supported File Types', true); ?>:  pdf, docx, gif, jpg, jpeg, png (Max. 10MB). </div>
                                </span>
                            </div>

                            <div class="form_lst" id="jdurlsec">
                                <label><?php echo __d('user', 'Job Description', true); ?> <span class="star_red">*</span></label>
                                <span class="rltv">
                            ...
                            <div class="form_lst" id="jdtextsec">
                                <label><?php echo __d('user', 'Job Description', true);?> <span class="star_red">*</span></label>
                            ...
                            <div class="form_lst">
                                ...
                                <span class="rltv"><?php echo $this->Form->text('Job.company_name', array('maxlength' => 100, 'class' => "required", 'placeholder' => __d('user', 'Company name', true))) ?></span>
                            </div>
                           
                           
                            <div class="form_lst">
                                <label><?php echo __d('user', 'Company Profile', true);?> <span class="star_red">*</span></label>
                                <span class="rltv"><?php echo $this->Form->textarea('Job.brief_abtcomp', array( 'class' => "required", 'placeholder' => __d('user', 'Job Description', true))) ?></span>
                            </div>
                            ...
                            <div class="form_lst">
                                <label><?php echo __d('user', 'Annual Salary', true);?></label>
                                <div class="rltv">
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12 col-xs-12">
                        ...
                        <?php echo $this->Form->hidden('Job.long'); ?>
                                        ...
                                        echo $this->Form->hidden('Job.old_description_document');
