...
$this->Html->addCrumb('Import Jobs');
?> 
<script>
    $().ready(function () {
                ...
                <div class="my_acc">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="my-profile-boxes">
                            <div class="my-profile-boxes-top"><h2><i><?php echo $this->Html->image('front/home/paper-color.png', array('alt' => '')); ?></i><span><?php echo __d('user', 'Import Jobs', true);?></span></h2></div>
