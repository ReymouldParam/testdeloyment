<?php
    $this->Html->addCrumb('Credits & Plans');
?>
<div class="my_accnt">
                ...
                <div class="my_acc">
					<div class="col-lg-12">
                        ...
                        <div class="my-profile-boxes">
                            <div class="my-profile-boxes-top my-education-boxes"><h2><i><?php echo $this->Html->image('front/home/member-purchase-icon.png', array('alt' => '')); ?></i><span><?php echo __d('user', 'Purchase Membership Plan', true); ?></span></h2><div class="add-alert"><a href="javascript:;">Total Credit:<?php echo $userCredit;?></a></div></div>
