...
<section class="browse-jobs-section">
    <div class="container">
        <div class="section-title text-center">
            <h2><?php echo __d('home', 'Browse Jobs') ?></h2>
        </div>
        <div class="browse-jobs-bx">
            <ul class="nav browse-jobs-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="bytitle-tab" data-toggle="tab" href="#bytitle" role="tab" aria-controls="bytitle" aria-selected="true"><?php echo __d('home','By Title') ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="byskill-tab" data-toggle="tab" href="#byskill" role="tab" aria-controls="byskill" aria-selected="false"><?php echo __d('home','By Skill',true); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="bycategory-tab" data-toggle="tab" href="#bycategory" role="tab" aria-controls="bycategory" aria-selected="false"><?php echo __d('home','By Category',true); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="popularrsearches-tab" data-toggle="tab" href="#popularrsearches" role="tab" aria-controls="popularrsearches" aria-selected="false"><?php echo __d('home','Popular Searches',true); ?></a>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="bytitle" role="tabpanel" aria-labelledby="bytitle-tab">
                    <div class="bytitle-category">
                        <!-- <ul>
                            ...
                            <li><a href="#">Systems Administrator</a></li>
                        ...
                        <?php $job_titles = ClassRegistry::init('Job')->find('all',array('conditions'=>array('Job.status'=>1,'Job.expire_time >='=>time())))?>
                        <ul>
                             <?php foreach($job_titles as $job_title){ ?>
                                 <li><a href="<?php echo $this->Html->url(array("controller" => "jobs", "action" => 'listing',$job_title['Job']['slug'])); ?>"><?php echo ucfirst($job_title['Job']['title']); ?></a></li> 
                            <?php } ?>                
                        </ul>
                    </div>
                </div>
                <div class="tab-pane fade" id="byskill" role="tabpanel" aria-labelledby="byskill-tab">
                    <?php $job_skills = ClassRegistry::init('Skill')->find('all',array('conditions'=>array('Skill.status'=>1,'Skill.type'=>'Skill')))?>
                    <div class="bytitle-category">
                          <ul>
                            <?php foreach($job_skills as $job_skill){ ?>
                                <li><a href="<?php echo $this->Html->url(array("controller" => "jobs", "action" => 'listing',$job_skill['Skill']['slug'])); ?>"><?php echo ucfirst($job_skill['Skill']['name']); ?></a></li> 
                            <?php } ?>
                          </ul>      
                        <!-- <ul>
                            <li><a href="#">SQL Developer</a></li>
                ...
                <div class="tab-pane fade" id="bycategory" role="tabpanel" aria-labelledby="bycategory-tab">
                    <?php $job_categories = ClassRegistry::init('Category')->find('all',array('conditions'=>array('Category.status'=>1,'Category.parent_id'=>0)))?>
                    ...
                    <div class="bytitle-category">
                        ...
                        <ul>
                            <?php foreach($job_categories as $job_category){ ?>
                                <li><a href="<?php echo $this->Html->url(array("controller" => "jobs", "action" => 'listing',$job_category['Category']['slug'])); ?>"><?php echo ucfirst($job_category['Category']['name']); ?></a></li> 
                            <?php } ?>
                        </ul>
                    </div>
                </div>
                <div class="tab-pane fade" id="popularrsearches" role="tabpanel" aria-labelledby="popularrsearches-tab">
                    <?php $job_keywords = ClassRegistry::init('Keyword')->find('all',array('conditions'=>array('Keyword.status'=>1,'Keyword.approval_status'=>1)))?>
                    <div class="bytitle-category">
                        <!-- <ul>
                            <li><a href="#">DBA</a></li>
                            <li><a href="#">SQL Developer</a></li>
                        ...
                        <ul>
                            <?php foreach($job_keywords as $job_keyword){ ?>
                                <li><a href="<?php echo $this->Html->url(array("controller" => "jobs", "action" => 'listing',$job_keyword['Keyword']['slug'])); ?>"><?php echo ucfirst($job_keyword['Keyword']['name']); ?></a></li> 
                            <?php } ?>
                        </ul>
                    </div>
                </div>
...
<section class="Featured_Jobs">
    <div class="job-post-area pt-100 pb-100 minus-15 clearfix">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title text-center">
            ...
            <div class="featured-job-list-bx">
                                    ...
                                    <div class="single-job" data-aos="fade-left">
                                        <div class="job-meta">
                                            ...
                                            <div class="meta-info">
                                                ...
                                                <?php if (isset($job['Job']['min_salary']) && isset($job['Job']['max_salary'])) {
        ...
        <?php echo $this->Html->image('front/home/share-icon.png', array('alt' => '')); ?>
                                        ...
                                        <div class="client-logo-img">
                                            ...
                                            <div class="job-locations">
                                                <p><i><?php echo $this->Html->image('front/home/location-icon.png', array('alt' => '')); ?></i><a href="<?php echo HTTP_PATH . '/' . $job['Category']['slug'] . '/' . $job['Job']['slug'] . '.html' ?>"><?php echo $job['Job']['job_city'] ? $job['Job']['job_city'] : 'N/A'; ?></a></p>
                                            </div>
                                            <div class="job-times"><i class="fa fa-calendar" aria-hidden="true"></i><?php
...
<?php } ?>
                ...
                <div class="featured-view-jobs">
                    <a href="<?php echo $this->Html->url(array("controller" => "jobs", "action" => 'listing','')); ?>"><?php echo __d('home','VIEW ALL JOBS',true) ?></a>
                </div>
            </div>
        </div>
    </div>
