        ...
        <div class="container">
            <div class="my_acc">
                ...
                ?></div>
                            ...
                            <div class="users-informetion-detal con-left-bx"><i><?php echo $this->Html->image('front/home/phone-icon.png', array('alt' => '')); ?></i> <span><?php echo $this->Text->usformat($userdetail['User']['contact']); ?></span></div>
                        ...
                        <div class="information_cntn">
                           ...
                           <!-- <?php //if ($userdetail['City']['city_name']) { ?>
                            ...
                            <div class="form_lst">
                                ...
                                <span class="rltv"><em><?php echo $this->Text->usformat($userdetail['User']['contact']); ?> </em></span>
                            </div>
                            <?php } ?>
