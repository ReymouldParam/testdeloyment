...
$this->Html->addCrumb('<i class="fa fa-plus"></i> Edit Jobseeker Details', 'javascript:void(0)', array('escape' => false));
?>
...
<section id="main-content" class="site-min-height">
    <section class="wrapper">
        <div class="row">
            ...
            <div class="col-lg-12">
                <h4 style="margin-left:15px" class="m-bot15">Edit Jobseeker</h4>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Jobseeker Status<div class="required_field"></div></label>
                            <div class="col-sm-10" >
                                ...
                                <span class="help_textnomi">Click above to change Jobseeker's status.</span>
                                <br/>
				...
				<section class="panel">
                    <header class="panel-heading">
                        Employee Verfication Details:
                    </header>
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Verfication Status <div class="required_field"></div></label>
                            <div class="col-sm-10" >
								<?php echo $this->Form->select('User.emp_verification_status', array('Pending'=>'Pending','Verified'=>'Verified'), array('data-placeholder'=>'Choose Verfication Status', 'class'=>"chosen-select form-control ", 'empty'=>'Select Verfication Status')); 
								?>
                               
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Verfication Source <div class="required_field">*</div></label>
                            <div class="col-sm-10" >
                               <?php echo $this->Form->select('User.verification_source', array('email'=>'Email','document'=>'Document'), array('data-placeholder'=>'Choose Verfication Source', 'class'=>"chosen-select form-control ", 'empty'=>'Select Verfication Source')); 
								?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Verfication Date <div class="required_field">*</div></label>
                            <div class="col-sm-10" >
                                <?php echo $this->Form->text('User.verification_date', array('label' => '', 'div' => false, 'class' => "form-control datepicker")) ?>
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-9">
                     <?php
                        ...
                        echo $this->Form->hidden('User.old_cv');
