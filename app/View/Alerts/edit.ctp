...
<style>
    ...
    <?php
        $this->Html->addCrumb('Alerts', array('controller' => 'alerts', 'action' => 'index'));
            ...
            <div class="my_acc">
               <div class="col-lg-12" style="height:500px;">
                    ...
                    <div class="my-profile-boxes info_dv_esdit_pre">
                        <div class="my-profile-boxes-top my-education-boxes"><h2><i><?php echo $this->Html->image('front/home/edit-icon2.png', array('alt' => '')); ?></i><span><?php echo __d('user', 'Edit Alert', true);?></span></h2></div>
                        <div class="information_cntn" style="position:inherit !important;">
                            ...
                            <div class="form_list_education" id="div_subcat">
                                <label class="lable-acc"><?php echo __d('user', 'Location', true);?> <span class="star_red">*</span><!--<span class="subcat_help_text"></span>--></label>
                                <span class="form_input_education" id="subcat">
                            ...
                            <div class="form_list_education">
                                ...
                                <div id="locDiv" class="form_input_education">
                                    <span>
                                        <?php echo $this->Form->select('Alert.skill', $skillList, array('empty' => __d('user', 'Select Skill', true), 'class' => "form-control required"));  ?>
                                    </span>
                                </div>
                            </div>

                            <div class="form_list_education">
                                <label class="lable-acc"><?php echo __d('user', 'Designation', true);?> </label>
                                <div id="locDiv" class="form_input_education">
