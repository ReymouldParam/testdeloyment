                        ...
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
									...
									<th class="sorting_paging"><?php echo $this->Paginator->sort('User.emp_verification_status', 'Emp. Verfication'); ?></th>
									<th class="sorting_paging">Verify Document</th>
									<th class="sorting_paging">Source</th>
									<th class="sorting_paging">Verfication Date</th>
                            ...
                            <tbody>
                                ...
                                foreach ($candidates as $user) {
                                    ?>
                                    <tr id="jobseeker<?php echo $user['User']['id']; ?>">
                                            ...
                                            <?php 
                                                ...
                                                if (!empty($doc) && file_exists(UPLOAD_EMPLOYEE_VERIFICATION_PATH . $doc)) {
                                                    ...
                                                    if(in_array(pathinfo($doc, PATHINFO_EXTENSION),$pdf)){
                                                        ...
                                                        ?>
                                                        <a href="<?php echo DISPLAY_EMPLOYEE_VERIFICATION_PATH . $doc; ?>"
                                                        title="<?php echo strtoupper(substr($doc, 6)); ?>" target="_blank">
                                       ...
                                       <!-- <td data-title="Email"><?php //echo $user['City']['city_name']?$user['City']['city_name']:'N/A';   ?></td>-->
                                        ...
                                        <td data-title="Action">
                                            ...
                                            echo $this->Ajax->link('<button class="btn btn-info btn-xs"><i class="fa fa-check"></i></button>', array('controller' => 'candidates', 'action' => 'verifyuser', $user['User']['slug']), array('update' => 'jobseeker' . $user['User']['id'], 'indicator' => 'loaderIDAct' . $user['User']['id'], 'confirm' => 'Are you sure you want to Verify this user?', 'escape' => false, 'title' => 'Verify'));
                                            }
                                            ?>
