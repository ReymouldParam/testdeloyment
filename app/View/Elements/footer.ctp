                        ...
                        <li class="widget-container widget_nav_menu">
                            ...
                            <div class="ftblock1">
                                <ul class="user_link">
                                    ...
                                    <li>
                                        <?php echo $this->Html->link(__d('home', 'Sign In', true), array('controller' => 'users', 'action' => 'login'), array('class' => '')); ?>
                                    </li>
                                    <li>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="footer-bottom text-center">
                         <p style="display: none;"> <?php //echo __d('user', 'Copyright', true) ?> © <?php //echo date("Y"); ?> | <?php //echo $company_name; ?> | <a target="_blank" href="https://stage.reyferjobs.com/" >White Labeled Recruitment Software</a></p>
                         <p> © <?php echo __d('user', 'Copyright', true) ?> @ <?php echo date("Y"); ?> | <a href="https://stage.reyferjobs.com/" target="_blank">Job Board Software</a> by Reyferjobs. All Rights Reserved</p>
											...
											<div class="container">
												<div class="row">
													<div class="col-sm-12">
														...
														<button type="button" class="btn btn-secondary empbtnyesno laterOption" data-dismiss="modal">Later</button>
...
<script>
	...
	$( ".laterOption" ).click(function () {
		
		$('.header').css({'z-index':'9999'});
		$.ajax({
			type: "GET",
			url: "<?php echo HTTP_PATH . "/jobs/employeeVerficationLater" ?>",
	...
	<?php
	if($this->request->params['action']=='myaccount'){?>
	...
	function showEmail1(){
		$('#emailDiv1').show();
		$('#documentDiv1').hide();
		$("#emailemployeeDiv1").show();
		$("#otpemployeeDiv1").hide();
	...
	$('#empEmailVerfication1').on('submit', function(e){
        e.preventDefault();
        var dataString = $("#empEmailVerfication1").serialize();
		$.ajax({
			type: "POST",
			url: "<?php echo HTTP_PATH . "/jobs/employeeEmailVerfication" ?>",
			data: dataString,
				...
				else
				{
					if(response.type=='email'){
						Swal.fire({
							...
							$("#emailemployeeDiv1").hide();
							$("#otpemployeeDiv1").show();
	...
	$('#empDocVerfication1').on('submit', function(e){
		 e.preventDefault();
        //var dataString = $("#empDocVerfication").serialize();
		$.ajax({
			type: "POST",
